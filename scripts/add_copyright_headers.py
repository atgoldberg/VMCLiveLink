...
def process_file(path):
    ...
    # Also check for any copyright line that doesn't have our specific format
    is_copyright_line = re.match(r"//\s*Copyright\s+", first_line_no_eol, flags=re.I)
    if m:
        years_str = m.group(1)
        ...
        if first_line_no_eol != desired_header_line:
            ...
            updated = True
    elif is_copyright_line:
        # Replace any copyright line that doesn't match our format
